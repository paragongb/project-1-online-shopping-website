...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.paragon.project1.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.paragon.project1.repository.UserRepository.USERS_BY_EMAIL_CACHE);
