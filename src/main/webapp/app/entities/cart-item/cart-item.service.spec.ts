...
describe('Service Tests', () => {
  describe('CartItem Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new CartItem(123, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a CartItem', async () => {
      ...
      it('should update a CartItem', async () => {
        const returnedFromService = { quantity: 1, ...elemDefault };
      ...
      it('should not update a CartItem', async () => {
      ...
      it('should partial update a CartItem', async () => {
        const patchObject = { quantity: 1, ...new CartItem() };
      ...
      it('should not partial update a CartItem', async () => {
      ...
      it('should return a list of CartItem', async () => {
        const returnedFromService = { quantity: 1, ...elemDefault };
        const expected = { ...returnedFromService };
      ...
      it('should not return a list of CartItem', async () => {
        axiosStub.get.mockRejectedValue(error);
      ...
      it('should not delete a CartItem', async () => {
